...
};gdjs.Ginja_32EnigmaCode.asyncCallback30990612 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Ginja_32EnigmaCode.asyncCallback30990612(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Ginja_32EnigmaCode.asyncCallback31023668 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Ginja_32EnigmaCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Ginja_32EnigmaCode.asyncCallback31023668(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().getFromIndex(1).setString("BOOZER");
}}
