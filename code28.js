...
};gdjs.Bica_32EnigmaCode.asyncCallback11064748 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Bica_32EnigmaCode.asyncCallback11064748(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Bica_32EnigmaCode.asyncCallback11067268 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Bica_32EnigmaCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Bica_32EnigmaCode.asyncCallback11067268(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("ok"), gdjs.Bica_32EnigmaCode.GDokObjects2);
{for(var i = 0, len = gdjs.Bica_32EnigmaCode.GDokObjects2.length ;i < len;++i) {
    gdjs.Bica_32EnigmaCode.GDokObjects2[i].hide(false);
}
}}
...
if (isConditionTrue_0) {
/* Reuse gdjs.Bica_32EnigmaCode.GDokObjects1 */
{for(var i = 0, len = gdjs.Bica_32EnigmaCode.GDokObjects1.length ;i < len;++i) {
    gdjs.Bica_32EnigmaCode.GDokObjects1[i].hide();
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("pistagm"), gdjs.Bica_32EnigmaCode.GDpistagmObjects1);
{for(var i = 0, len = gdjs.Bica_32EnigmaCode.GDfundopistagmObjects1.length ;i < len;++i) {
    gdjs.Bica_32EnigmaCode.GDfundopistagmObjects1[i].getBehavior("Animation").setAnimationIndex(4);
}
}{for(var i = 0, len = gdjs.Bica_32EnigmaCode.GDpistagmObjects1.length ;i < len;++i) {
    gdjs.Bica_32EnigmaCode.GDpistagmObjects1[i].setFontName("JMH Typewriter-Thin.ttf");
}
}{for(var i = 0, len = gdjs.Bica_32EnigmaCode.GDpistagmObjects1.length ;i < len;++i) {
    gdjs.Bica_32EnigmaCode.GDpistagmObjects1[i].setColor("0;0;0");
}
}}
