...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15306460);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15318396);
}
if (isConditionTrue_0) {
...
};gdjs.QR_95Code_95readerCode.asyncCallback15317524 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.QR_95Code_95readerCode.asyncCallback15317524(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13685980);
}
if (isConditionTrue_0) {
